...
`
    ...
    class Simulation {
      ...
      advection: any; externalForce: any; viscousPass: any; divergence: any; poisson: any; pressure: any
      ...
      createAllFBO() {
        ...
        const opts: THREE.WebGLRenderTargetOptions = { type, depthBuffer: false, stencilBuffer: false, minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, wrapS: THREE.ClampToEdgeWrapping, wrapT: THREE.ClampToEdgeWrapping }
    ...
    class Output {
      ...
      addScene(mesh: THREE.Object3D) { this.scene.add(mesh) }
    ...
    BFECC, cursorSize, dt, isBounce, isViscous, iterationsPoisson, iterationsViscous, mouseForce,
    resolution, viscous, colors, autoDemo, autoSpeed, autoIntensity, takeoverDuration, autoResumeDelay,
    autoRampDuration
  ])
  ...
  useEffect(() => {
    ...
    mouseForce, cursorSize, isViscous, viscous, iterationsViscous, iterationsPoisson, dt, BFECC, resolution,
    isBounce, autoDemo, autoSpeed, autoIntensity, takeoverDuration, autoResumeDelay, autoRampDuration
  ])
