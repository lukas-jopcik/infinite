    ...
    <article className="py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <nav aria-label="Breadcrumb">
          <Link href="/hubble-obrazky" className="inline-flex items-center text-gray-400 hover:text-white transition-colors mb-8" aria-label="Späť na Hubble obrázky">
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
            </svg>
            Späť na Hubble obrázky
          </Link>
        </nav>
        ...
        <DetailNav newer={newer} older={older} basePath="/hubble-obrazky" />
