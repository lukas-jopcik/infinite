/**
 * Fast Bulk SEO Article Generation Script
...
const DELAY_BETWEEN_BATCHES = 30000; // 30 seconds instead of 2 minutes
const DELAY_BETWEEN_ITEMS = 5000; // 5 seconds between items
...
async function processBatch(items, startIdx) {
    ...
    for (const item of batch) {
        ...
        // Shorter delay between individual requests (5 seconds)
...
async function main() {
    console.log('🚀 Starting FAST bulk SEO article generation...');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
