...
/**
 * Real-time test for SEO article generation
 * Uses proper format for reprocess API
 */

const https = require('https');

async function testSeoRealtime() {
    console.log('🧪 Testing SEO Article Generation (Real-time)...');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    ...
    try {
        ...
        console.log(`🎯 Topic: ${requestBody.seoArticleConfig.topic}`);
        console.log(`🔑 Keywords: ${requestBody.seoArticleConfig.keywords}`);
        console.log(`👥 Target Audience: ${requestBody.seoArticleConfig.targetAudience}`);
        console.log('');
        ...
        if (result.statusCode === 202) {
            ...
            console.log('💡 Wait 30 seconds and check the content using:');
